...
def OptimizationUTRcodon(gene_sequence, five_prime_utr, start_codon_index, stop_codon_index, target_initiation_rate, iterations):
    ...
    data = []
    I_old = round(InitiationRate.InitiationRate(seq_final, start_codon_index, stop_codon_index), 4)
    I = I_old
    ...
    for i in range(iterations):
        ...
        I_new = round(InitiationRate.InitiationRate(gene, start_codon_index, stop_codon_index), 4)
